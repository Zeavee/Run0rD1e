package ch.epfl.sdp.entities.shelter_area;
...
public class ShelterAreaTest {
    ...
    public void ShelterTest() {
        ...
        assertFalse(player2.status.isShielded());
        assertFalse(player3.status.isShielded());
        assertFalse(player4.status.isShielded());
        assertTrue(player1.status.isShielded());
    }
